...
import OpsConsolePage from './ops-console/page'
...
`
  ...
  // Landing Page View — render the Ops Console as the primary admin surface.
  // All previous card-grid links remain accessible via the Ops Console sidebar's
  // "Admin Workspaces" group (see data.ts TREE).

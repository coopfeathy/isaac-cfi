          ...
          <div className="space-y-16 sm:space-y-20 md:space-y-24">
            ...
            <div className="bg-gradient-to-br from-gray-50 to-white rounded-3xl shadow-xl border border-gray-200 overflow-hidden">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-0">
                <div className="bg-gray-200 h-64 sm:h-80 lg:h-auto flex items-center justify-center">
                  <div className="text-gray-400 text-center p-8">
                    <svg className="w-20 h-20 mx-auto mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
                    </svg>
                    <p className="text-sm font-light">Aircraft Image</p>
                  </div>
                </div>
                <div className="p-8 sm:p-10 md:p-12">
                  ...
                  <div className="mb-6 pb-6 border-b border-gray-200">
                    <p className="text-gray-600 font-medium mb-2">📍 N14 (Flying W Airport)</p>
            ...
            <div className="bg-gradient-to-br from-gray-50 to-white rounded-3xl shadow-xl border border-gray-200 overflow-hidden">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-0">
                <div className="bg-gray-200 h-64 sm:h-80 lg:h-auto flex items-center justify-center order-2 lg:order-1">
                  <div className="text-gray-400 text-center p-8">
                    <svg className="w-20 h-20 mx-auto mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
                    </svg>
                ...
                <div className="p-8 sm:p-10 md:p-12 order-1 lg:order-2">
                  ...
                  <div className="mb-6 pb-6 border-b border-gray-200">
                    <p className="text-gray-600 font-medium mb-2">📍 FRG (Republic Airport)</p>
            ...
            <div className="bg-gradient-to-br from-gray-50 to-white rounded-3xl shadow-xl border border-gray-200 overflow-hidden">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-0">
                ...
                <div className="p-8 sm:p-10 md:p-12">
                  ...
                  <div className="mb-6 pb-6 border-b border-gray-200">
                    <p className="text-gray-600 font-medium mb-2">📍 N72 (Warwick Municipal Airport)</p>

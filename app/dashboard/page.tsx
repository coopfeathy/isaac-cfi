          ...
          <div className="space-y-6">
            <div className="bg-white rounded-lg shadow-md p-8">
              ...
              {socialMessage && (
                <div
                  className={`mb-6 p-4 rounded-lg ${
                    socialMessage.startsWith('Error')
                      ? 'bg-red-100 text-red-700'
                      : 'bg-green-100 text-green-700'
                  }`}
                >
                    ...
                    onChange={(e) => {
                      ...
                      setSocialForm((prev) => {
                        ...
                        return {
                          ...
                          thumbnail: shouldAutofillThumbnail && autoThumb ? autoThumb : prev.thumbnail,
                        }
                      })
                    }}
                    className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-golden focus:border-transparent"
                ...
                <div>
                  ...
                  <div className="mt-3 p-3 bg-blue-50 border border-blue-200 rounded-lg">
                    ...
                    <input
                      ...
                      onChange={(e) => {
                        const file = e.target.files?.[0]
                        if (file) handleSocialThumbnailUpload(file)
                      }}
                      disabled={uploadingSocialThumbnail}
                      className="text-sm"
                    />
                    {uploadingSocialThumbnail && (
                      <p className="text-xs text-blue-700 mt-2">Uploading thumbnail...</p>
                    )}
                  </div>
                  {socialForm.thumbnail && (
                    <img
                      src={socialForm.thumbnail}
                      alt="Thumbnail preview"
                      className="mt-3 w-full max-w-xs rounded border border-gray-200"
                    />
                  )}
                </div>
                    ...
                    <div key={post.id} className="border border-gray-200 rounded-lg p-4">
                      <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-3">
                        ...
                        <div className="flex gap-2 shrink-0">
                          <button
                            onClick={() => handleEditSocialPost(post)}
                            className="px-3 py-1 text-sm bg-blue-500 text-white rounded hover:bg-blue-600"
                          >
                            Edit
                          </button>
